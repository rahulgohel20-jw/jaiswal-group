...
// ---------------------------------------------------------------------------
export default function ApprovalView({ requisition, onBack }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <button className="cursor-pointer h-11 px-4 rounded-xl bg-[#2952E3] text-white text-sm font-semibold flex items-center gap-2 hover:bg-[#2444c4] transition-colors shrink-0">
          <Plus size={15} />
          Add item
        </button>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#E7EAF0] overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#E7EAF0]">
          ...
          <div className="flex items-center gap-2">
            <button className="cursor-pointer h-9 px-3.5 rounded-lg border border-[#E7EAF0] text-xs font-medium text-[#344054] flex items-center gap-1.5 hover:bg-[#F9FAFC]">
              <Filter size={13} />
              Filter
            </button>
            <button className="cursor-pointer h-9 px-3.5 rounded-lg border border-[#E7EAF0] text-xs font-medium text-[#344054] flex items-center gap-1.5 hover:bg-[#F9FAFC]">
      ...
      <div className="flex items-center justify-end gap-3 mt-6">
        <button className="cursor-pointer h-11 px-5 rounded-xl border border-[#E7EAF0] bg-white text-sm font-semibold text-[#344054] hover:bg-[#F9FAFC] transition-colors">
          Save
        </button>
        <button className="cursor-pointer h-11 px-5 rounded-xl bg-[#2952E3] text-white text-sm font-semibold flex items-center gap-2 hover:bg-[#2444c4] transition-colors">
