    ...
    <div className="min-h-screen bg-gray-50 -mt-4">
      <div className="max-w-4xl mx-auto space-y-5 pt-2">
        ...
        <div className="flex items-center gap-3 mb-1">
          <div>
            <h1 className="text-2xl font-bold text-sky-900 leading-none">Register New Company</h1>
            <p className="text-xs text-gray-400 mt-0.5">Complete the form below to establish a new corporate entity in the Jaiswal Group ecosystem.</p>
          </div>
        </div>
        ...
        {/* Info note */}
        <div className="flex items-start gap-3 px-5 py-4 rounded-2xl border border-blue-100 bg-blue-50/60">
          <Info className="w-4 h-4 text-blue-500 flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-semibold text-blue-900">Need help with registration?</p>
            <p className="text-xs text-blue-700/80 mt-1 leading-relaxed">
              Ensure all mandatory fields marked with an asterisk (*) are filled correctly. The
              company code is auto-generated based <br /> on current fiscal year and regional sequences.
            </p>
          </div>
        </div>
